...
const Card5 = () => {
  const [image, setImage] = useState(images.Hoodie2_og);
  ...
  const handleGrey = () => {
    const f = document.getElementById("motion-img5");
    f.setAttribute(
      "style",
        ...
        >
          <div className="card-upper">
            <div className="card-logo">
              <img src={images.nike_logo} alt="" style={{ scale: "1.2" }} />
            </div>
