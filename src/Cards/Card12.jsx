...
const Card12 = () => {
  const [image, setImage] = useState(images.Shirt2_og);
  ...
  const handleGrey = () => {
    const f = document.getElementById("motion-img12");
    f.setAttribute(
      "style",
        ...
        >
          <div className="card-upper">
            <div className="card-logo">
              <img src={images.puma_logo} alt="" style={{ scale: "1.5" }} />
            </div>
            <div className="card-main">
              <div className="descr">
                <h2>PUMA Men Regular, Slim, Tailored Fit</h2>
                <p>
              ...
              <div className="main-img">
                <motion.img src={image} alt="" id="motion-img12" />
