...
const Card8 = () => {
  const [image, setImage] = useState(images.Pants1_og);
  ...
  const handleGrey = () => {
    const f = document.getElementById("motion-img8");
    f.setAttribute(
      "style",
        ...
        >
          <div className="card-upper">
            ...
            <div className="card-main">
              <div className="descr">
                <h2>LEVI'S 512 Men Tapered Fit Mid Rise</h2>
                <p>
              ...
              <div className="main-img">
                <motion.img src={image} alt="" id="motion-img8" />
