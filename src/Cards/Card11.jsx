...
const Card11 = () => {
  const [image, setImage] = useState(images.Shirt1_og);
  ...
  const handleGrey = () => {
    const f = document.getElementById("motion-img11");
    f.setAttribute(
      "style",
        ...
        >
          <div className="card-upper">
            ...
            <div className="card-main">
              <div className="descr">
                <h2>PUMA Washed Cut Away Collar Casual Shirt</h2>
                <p>
              ...
              <div className="main-img">
                <motion.img src={image} alt="" id="motion-img11" />
