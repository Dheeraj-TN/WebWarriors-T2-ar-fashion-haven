...
const Card = () => {
  const [image, setImage] = useState(images.tshirt_3);
  ...
  const handleGrey = () => {
    const f = document.getElementById("motion-img1");
    f.setAttribute(
      "style",
  ...
  return (
    <>
      <div className="Card-Wrapper">
        <motion.div
          className="card"
          style={{ x, y, rotateX, rotateY, z: 100, marginTop: "-13px" }}
          drag
          dragElastic={0.05}
          ...
          <div className="card-upper">
            ...
            <div className="card-main">
              ...
              <div className="main-img">
                <motion.img src={image} alt="" id="motion-img1" />
