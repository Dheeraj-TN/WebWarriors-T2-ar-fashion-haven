...
const Card9 = () => {
  const [image, setImage] = useState(images.Pants2_og);
  ...
  const handleGrey = () => {
    const f = document.getElementById("motion-img9");
    f.setAttribute(
      "style",
        ...
        >
          <div className="card-upper">
            ...
            <div className="card-main">
              <div className="descr">
                <h2>LEVI'S Men Slim Mid Rise </h2>
                <p>
              ...
              <div className="main-img">
                <motion.img src={image} alt="" id="motion-img9" />
