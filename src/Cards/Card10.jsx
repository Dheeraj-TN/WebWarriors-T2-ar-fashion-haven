...
const Card10 = () => {
  const [image, setImage] = useState(images.Pants3_og);
  ...
  const handleGrey = () => {
    const f = document.getElementById("motion-img10");
    f.setAttribute(
      "style",
        ...
        >
          <div className="card-upper">
            <div className="card-logo">
              <img src={images.levis_log} alt="" />
            </div>
            <div className="card-main">
              <div className="descr">
                <h2>LEVI'S Men Solid Green Track Pants</h2>
                <p>
              ...
              <div className="main-img">
                <motion.img src={image} alt="" id="motion-img10" />
